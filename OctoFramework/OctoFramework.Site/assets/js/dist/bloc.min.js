...
"use strict";function executePageFunctions(){var n=arguments.length>0&&void 0!==arguments[0]&&arguments[0],e=document.body;n?pageFunctions.common.finalize():pageFunctions.common.init();var i=!0,t=!1,o=void 0;try{for(var a,r=e.classList[Symbol.iterator]();!(i=(a=r.next()).done);i=!0){var c=a.value;c=c.replace(/-/g,"_"),n?void 0!==pageFunctions[c]&&void 0!==pageFunctions[c].finalize&&pageFunctions[c].finalize():void 0!==pageFunctions[c]&&void 0!==pageFunctions[c].init&&pageFunctions[c].init()}}catch(n){t=!0,o=n}finally{try{!i&&r.return&&r.return()}finally{if(t)throw o}}}function normalizeElementHeights(n){var e=document.body.querySelectorAll(n),i=0;if(e){var t=!0,o=!1,a=void 0;try{for(var r,c=e[Symbol.iterator]();!(t=(r=c.next()).done);t=!0){var l=r.value;e.hasOwnProperty(l)&&(l.style.minHeight=0,i=l.offsetHeight>i?l.offsetHeight:i)}}catch(n){o=!0,a=n}finally{try{!t&&c.return&&c.return()}finally{if(o)throw a}}var s=!0,_=!1,u=void 0;try{for(var d,v=e[Symbol.iterator]();!(s=(d=v.next()).done);s=!0){var m=d.value;e.hasOwnProperty(m)&&(m.style.minHeight=i+"px")}}catch(n){_=!0,u=n}finally{try{!s&&v.return&&v.return()}finally{if(_)throw u}}}}var pageFunctions={common:{init:function(){},finalize:function(){}}};document.addEventListener("DOMContentLoaded",function(){executePageFunctions(!0)}),executePageFunctions(),$(document).ready(function(){$(".carousel__content").slick({infinite:!0,slidesToShow:2,slidesToScroll:1,prevArrow:'<button type="button" class="slick-prev"></button>',nextArrow:'<button type="button" class="slick-next"></button>',responsive:[{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1,infinite:!0}}]})}),$(".masonry-grid__section-container").isotope({itemSelector:".masonry-grid__section",layoutMode:"masonry"}),$(".header__navigation__mobile-link").click(function(){$(".header__navigation").toggleClass("--active"),$(".header__navigation__mobile-menu-icon__bar").toggleClass("--open")}),$(".header__navigation__menu__item__link").focus(function(){$(".header__navigation").addClass("--active"),$(".header__navigation__mobile-menu-icon__bar").addClass("--open")}),$(".header__navigation__menu__item__link").blur(function(){$(".header__navigation").removeClass("--active"),$(".header__navigation__mobile-menu-icon__bar").removeClass("--open")}),$(".header__navigation__mobile-close").click(function(){$(".header__navigation").removeClass("--active"),$(".header__navigation__mobile-menu-icon__bar").removeClass("--open")}),$(document).ready(function(){$("a").on("click",function(n){if(""!==this.hash){n.preventDefault();var e=this.hash;$("html, body").animate({scrollTop:$(e).offset().top},800,function(){window.location.hash=e})}})});